    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public BatchDeleteEventMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleCalendarConnector at batchDeleteEvent retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
