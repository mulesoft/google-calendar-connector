...
/**
 * GetInstancesMessageProcessor invokes the {@link org.mule.module.google.calendar.GoogleCalendarConnector#getInstances(org.mule.api.MuleMessage, java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, boolean, java.lang.String, java.lang.String)} method in {@link GoogleCalendarConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final Integer _transformedMaxResults = ((Integer) evaluateAndTransform(getMuleContext(), event, GetInstancesMessageProcessor.class.getDeclaredField("_maxResultsType").getGenericType(), null, maxResults));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleCalendarConnector) object).getInstances(event.getMessage(), _transformedCalendarId, _transformedEventId, _transformedMaxAttendess, _transformedMaxResults, _transformedShowDeleted, _transformedTimezone, _transformedOriginalStart);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getInstances"), event, e);
        }
    }
