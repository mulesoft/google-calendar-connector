    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public UpdateEventMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedCalendarId = ((String) evaluateAndTransform(getMuleContext(), event, UpdateEventMessageProcessor.class.getDeclaredField("_calendarIdType").getGenericType(), null, calendarId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleCalendarConnector) object).updateEvent(_transformedCalendarId, _transformedEventId, _transformedCalendarEvent);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleCalendarConnector at updateEvent retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
