    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteCalendarMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((GoogleCalendarConnector) object).deleteCalendar(_transformedId);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleCalendarConnector at deleteCalendar retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
