    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public BatchUpdateCalendarMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleCalendarConnector) object).batchUpdateCalendar(_transformedCalendars);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleCalendarConnector at batchUpdateCalendar retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
